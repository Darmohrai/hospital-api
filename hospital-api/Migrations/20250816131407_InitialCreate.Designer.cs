...
namespace hospital_api.Migrations
{
    ...
    [Migration("20250816131407_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("hospital_api.Models.StaffAggregate.Dentist", b =>
                {
            ...
            modelBuilder.Entity("hospital_api.Models.StaffAggregate.Gynecologist", b =>
                {
                    b.HasBaseType("hospital_api.Models.StaffAggregate.Doctor");
            ...
            modelBuilder.Entity("hospital_api.Models.StaffAggregate.Neurologist", b =>
                {
                    b.HasBaseType("hospital_api.Models.StaffAggregate.Doctor");
            ...
            modelBuilder.Entity("hospital_api.Models.StaffAggregate.Radiologist", b =>
                {
                    b.HasBaseType("hospital_api.Models.StaffAggregate.Doctor");
            ...
            modelBuilder.Entity("hospital_api.Models.StaffAggregate.Surgeon", b =>
                {
                    b.HasBaseType("hospital_api.Models.StaffAggregate.Doctor");
            ...
            modelBuilder.Entity("hospital_api.Models.OperationsAggregate.Operation", b =>
                {
                    ...
                    b.HasOne("hospital_api.Models.StaffAggregate.Dentist", null)
                        .WithMany("Operations")
                    ...
                    b.HasOne("hospital_api.Models.StaffAggregate.Gynecologist", null)
                        .WithMany("Operations")
                    ...
                    b.HasOne("hospital_api.Models.StaffAggregate.Surgeon", null)
                        .WithMany("Operations")
            ...
            modelBuilder.Entity("hospital_api.Models.StaffAggregate.Dentist", b =>
                {
                    b.HasOne("hospital_api.Models.StaffAggregate.Doctor", null)
                        .WithOne()
                        .HasForeignKey("hospital_api.Models.StaffAggregate.Dentist", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("hospital_api.Models.StaffAggregate.Gynecologist", b =>
                {
                    b.HasOne("hospital_api.Models.StaffAggregate.Doctor", null)
                        .WithOne()
                        .HasForeignKey("hospital_api.Models.StaffAggregate.Gynecologist", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("hospital_api.Models.StaffAggregate.Neurologist", b =>
                {
                    b.HasOne("hospital_api.Models.StaffAggregate.Doctor", null)
                        .WithOne()
                        .HasForeignKey("hospital_api.Models.StaffAggregate.Neurologist", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("hospital_api.Models.StaffAggregate.Radiologist", b =>
                {
                    b.HasOne("hospital_api.Models.StaffAggregate.Doctor", null)
                        .WithOne()
                        .HasForeignKey("hospital_api.Models.StaffAggregate.Radiologist", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("hospital_api.Models.StaffAggregate.Surgeon", b =>
                {
                    b.HasOne("hospital_api.Models.StaffAggregate.Doctor", null)
                        .WithOne()
                        .HasForeignKey("hospital_api.Models.StaffAggregate.Surgeon", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
